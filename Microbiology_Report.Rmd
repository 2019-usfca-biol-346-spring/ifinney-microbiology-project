...
```{r colony-counts-statistics, echo = FALSE, message = FALSE}
...
```{r morphology-counts-statistics, echo = FALSE, message = FALSE}
# Do a statistical test to determine if there are differences
...
```{r final-colony-counts-statistics, echo = FALSE, message = FALSE}
# Do a statistical test to determine if there are differences
...
```{r final-morphology-counts-statistics, echo = FALSE, message = FALSE}
# Do a statistical test to determine if there are differences
