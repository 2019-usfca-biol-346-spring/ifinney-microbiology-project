...
The predictions I made for my selected morphotypes based on the staining results are as follows: morphotype #1 is Azomonas agilis, morphotype #2 is Staphylococcus aureus, morphotype #3 is a Acidovorax spp., morphotype #4 is a Streptococcus spp., morphotype #5 is Bacillus subtilis, morphotype #6 is a Pseudomonas spp., and morphotype #7 is a Bacilius spp. (Table 2). From all of microbes I analyzed, only the $3^{rd}$ and $4^{th}$ morphotypes were gram positive. In addition, the only cocci shaped bacteria I noted were morphotypes #1 and #2 (Fig.3, Fig.4).
