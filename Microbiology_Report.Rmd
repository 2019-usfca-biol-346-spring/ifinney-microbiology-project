...
#Read in csv files for final project with data
final_project_culturing_counts <- read.csv("data/raw_data/final_project_culturing_counts.csv")

final_project_culturing_V2 <- read.csv("data/raw_data/final_project_culturing_V2.csv")
```
...
```{r final-colony-counts-statistics}
# Do a statistical test to determine if there are differences
...
```{r final-morphology-counts-statistics}
# Do a statistical test to determine if there are differences
